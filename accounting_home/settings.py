...
ALLOWED_HOSTS = ['www.accountingbuddy.org','accountingbuddy.org','139.59.29.165','127.0.0.0']
...
TEMPLATES = [
    {
	   ...
	   # os.path.join(PROJECT_ROOT,"moderna/templates"),
	    ...
	    os.path.join(PROJECT_ROOT,"accountingbuddy/templates/accountingbuddy/"),
	    os.path.join(PROJECT_ROOT,"business/templates/business/"),
...
#LOGIN_REDIRECT_URL=reverse_lazy('accountingbuddy:pricing-india')
